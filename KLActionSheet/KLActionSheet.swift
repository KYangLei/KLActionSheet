...
public class KLActionSheet: UIViewController {
    //MARK: - public property
    public var handler: handlerAction?
    public var delegate: KLActionSheetDelegate?
    ...
    /// 为了更好的融合到当前视图中，弹出框默认alpha是0.8，默认是true，如果你不想要半透明，可以设置为false
    ...
    fileprivate let reuseIdentifier = "KLTableViewCell"
    fileprivate let reuseIdentifier1 = "KLTableViewTitleCell"
    ...
    fileprivate func setup() {
        ...
        tableView.alpha = 0.8
        tableView.register(KLTableViewCell.self, forCellReuseIdentifier: reuseIdentifier)
        tableView.register(KLTableViewTitleCell.self, forCellReuseIdentifier: reuseIdentifier1)
...
extension KLActionSheet {
    ...
    fileprivate func setCancelButtonTextColorAndTextFont(cell: KLTableViewCell) {
    ...
    fileprivate func setTextButtonTextColorAndTextFont(cell: KLTableViewCell) {
        if textColor != nil {
    ...
    fileprivate func setTitleColorAndTextFont(cell: KLTableViewTitleCell) {
...
extension KLActionSheet: UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if hasTitle() {
            if  indexPath.section == 0 {
                let cell: KLTableViewTitleCell = tableView.dequeueReusableCell(withIdentifier: reuseIdentifier1, for: indexPath) as! KLTableViewTitleCell
                cell.titlelabel.text = self.actionSheetTitle
                setTitleColorAndTextFont(cell: cell)
                return cell
            }
            let cell: KLTableViewCell = tableView.dequeueReusableCell(withIdentifier: reuseIdentifier, for: indexPath) as! KLTableViewCell
...
extension KLActionSheet: UITableViewDelegate {
